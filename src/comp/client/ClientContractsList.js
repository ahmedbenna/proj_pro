...
export default function ClientContractsList() {
    ...
    useEffect(() => {
        ...
        async function getContract() {
            try {
                const response = await axios.get('http://localhost:8088/contract/client/' + idc.id + '/getContract/pending');
            ...
            try {
                const response = await axios.get('http://localhost:8088/contract/client/' + idc.id + '/getContract/accept');
                console.log(response);
            ...
            try {
                const response = await axios.get('http://localhost:8088/contract/client/' + idc.id + '/getContract/reject');
                console.log(response);
