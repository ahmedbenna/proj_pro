...
export default function ProviderContractDetails(props) {
        ...
        <div>
            ...
            >
                ...
                <Grid container justifyContent='center' spacing={2} >
                    ...
                    <Grid item xs={12}>
                        {/* <Link state={{ id: props.c.client.id }} to='/ProviderPresenting'> */}
                                ...
                                <div class="row m-l-0 m-r-0">
                                    <div class="col-sm-4 bg-c-lite-green user-profile">
                                        <div class="card-block text-center text-white">
                                            ...
                                            <h6 class="f-w-600">{props.c.client.firstName} {props.c.client.lastName}</h6>
                                            {/* <p>{props.c.client.speciality.label}</p> */}
